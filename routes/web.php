...
Route::get('/delcomment', 'delcommentController@index')->name('delcomment')->middleware(['auth','auth.admin']);


Route::post('/destroy', 'delProductController@destroy')->name('destroy');
Route::get('/delproduct', 'delProductController@index')->name('delproduct')->middleware(['auth','auth.admin']);
